                        ...
                        <div className=' rounded-xl xl:w-96 lg:w-96 lg:h-72'>
                            <div className='xl:px-5 xl:py-6 '>
                                ...
                                <div className='flex flex-cols-2 gap-2 mt-3'>
                                    <div>
                                        <a href="https://playvalorant.com/en-us/download/" target="_blank" rel="noopener noreferrer">
                                            <img src="https://cdn1.codashop.com/S/content/mobile/images/pc_version_coda.png" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
